...
public class RobotMap {
	...
	// Robot Measurements
	public static double wheelBaseWidth = 29.75 * 2.54 * 1e-2;
	...
	public static int shooterMotor1 = 3; //TALON
	public static int shooterMotor2 = 2; //TALON
	public static int susanMotor = 6; // this is for the lazy-suzan
	public static int liftMotor = 4; //TALON

	public static int agitatorMotor = 7; // No longer a Talon TODO: FIX THIS
	public static int conveyor = 4;

	// Pneumatics
	public static int shiftGearSolenoidF = 0;
	public static int shiftGearSolenoidR = 1;// there will be two solenoids to lift
	// the feeder - check if present still
	// or was for other bot
	public static int liftSolenoid0 = 2;// there needs to be an additional
	// solenoid that permits the lift
	// mechanism to rotate backwards when
	// necessary
	public static int flapSolenoid0 = 3;
	// button ten - bot lift
